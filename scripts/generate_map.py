...
<style>
  ...
  *{{margin:0;padding:0;box-sizing:border-box}}
  ...
  .domain-chip{{display:inline-block;font-family:var(--font-mono);font-size:11px;letter-spacing:1px;color:#cdb98f;border:1px solid #3a3327;background:#241f16;padding:5px 12px;border-radius:20px;margin-bottom:24px}}
