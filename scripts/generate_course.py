...
.landing-hero .map-link { display:inline-flex; align-items:center; gap:6px; margin-top:24px; font-family:var(--font-mono); font-size:12px; color:#cdb98f; text-decoration:none; border:1px solid #3a3327; background:rgba(255,255,255,0.03); padding:8px 16px; border-radius:6px; transition:all .2s; }
.landing-hero .map-link:hover { border-color:#7fb89c; color:#e9e5dc; }
.mv-header .map-btn { margin-left:8px; text-decoration:none; }
...
<div class="landing" id="landing">
  <div class="landing-hero">
    ...
    <div><a class="map-link" href="../llmops-course-map.html">&#8862; View the course map &amp; cross-links &#8594;</a></div>
  </div>
...
<div class="module-view" id="moduleView">
  <div class="mv-header">
    ...
    <a class="back-btn map-btn" href="../llmops-course-map.html">&#8862; Course Map</a>
